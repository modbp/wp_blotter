 ...
 * 
 * BLOTTER->settings->get_plugin_name();
 * 
 * HELPER COMMENT END
 */

/**
 * Class Blotter_Settings
 *
 * This class contains all of the plugin settings.
 * Here you can configure the whole plugin data.
 *
 * @package		BLOTTER
 * @subpackage	Classes/Blotter_Settings
...
class Blotter_Settings{
	...
	/**
	 * Our Blotter_Settings constructor 
	...
	public function get_plugin_name(){
		return apply_filters( 'BLOTTER/settings/get_plugin_name', $this->plugin_name );
	}
}
